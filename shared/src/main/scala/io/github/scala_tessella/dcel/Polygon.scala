...
object Polygon:
  ...
  object SimplePolygon:
    ...
    /** Validates the list of interior angles for a simple polygon. It checks that no angle is a full circle
      * and that the sum of the angles is correct.
      *
      * @param angles
      *   A list of interior angles in degrees.
      * @return
      *   Either a String with an error message or Unit if validation succeeds.
      */
