...
//import io.github.scala_tessella.dcel.conversion.SvgAnimation.toUniformityAnimation
...
class TilingUniformitySpec extends AnyFlatSpec with Matchers with TilingTestHelpers:
  ...
  it should "find trees with regular polygons for each gonality order" in:
    ...
    allAssert(
      ...
      trees shouldBe
        List(
          (List(3, 3, 3, 3, 3, 3), Branch(88, List(Leaf(48), Leaf(24), Leaf(64)))),
          (List(3, 3, 3, 3, 6), Branch(84, List(Leaf(38), Leaf(67), Leaf(77))))
        )
    )
