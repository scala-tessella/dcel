...
class TilingDCELSpec extends AnyFlatSpec with Matchers with TilingTestHelpers:
  ...
  it should "calculate another" in {
    ...
    result.uniformity shouldBe Map(
      ...
      List(0) -> List("V15", "V16", "V17", "V18", "V19", "V25", "V28", "V36", "V37", "V38", "V41", "V51", "V80", "V90", "V93", "V103", "V106", "V116", "V137", "V138", "V145", "V146", "V147", "V148", "V149", "V155"),
