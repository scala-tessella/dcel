...
(uncapped, 12.8 h — the row's heavyweight: 289 supports × 35 compositions = 10 115 jobs)**; (8,5..6)
pending — if they match 537/203 the correction is fully localized to (8,2). (Operational note for future
